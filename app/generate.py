...
- Группируй и выбирай РОВНО те измерения, что явно названы в вопросе. Не \
добавляй лишних колонок в GROUP BY или SELECT.
- Для атрибутов пользователя (страна, тариф) джойни events/sessions с \
analytics.users по user_id.
- Для долей и условных подсчётов используй countIf/uniqIf, а не подзапросы.
